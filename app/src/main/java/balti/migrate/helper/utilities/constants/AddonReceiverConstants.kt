...
class AddonReceiverConstants {

    companion object {

        val EXTRA_ADDON_TYPE = "addon_type"
        val EXTRA_ADDON_TYPE_SETTINGS = "type_settings"
        val EXTRA_ADDON_TYPE_SMS_CALLS = "type_sms_calls"

        val ACTION_ADDON_SETTINGS_BROADCAST = "addon_settings_broadcast"
        val ACTION_ADDON_SETTINGS_SU = "addon_settings_su"
        val ACTION_ADDON_SMS_CALLS_PERMISSION = "addon_smsCalls_permission"
        val ACTION_ADDON_SMS_CALLS_RESTORE = "addon_smsCalls_restore"
    }
